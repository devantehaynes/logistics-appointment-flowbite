...
import { APP_NAME, LOGO } from "../public/config";
import { ModeToggle } from "./mode-toggle";

export default function Header() {
  const LOGO = "https://flowbite.com/docs/images/logo.svg";
  // const SIGN_UP = "/components/sign-up";
  const SIGN_UP = "/components/user-onboarding";
  const LOG_IN = "/components/log-in";
        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl ">
          ...
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              ...
              <li>
                <Link
                  href="/components/admin-appointments"
